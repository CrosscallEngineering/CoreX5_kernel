...
enum pon_restart_reason {
	...
	/* Hs restart reason start from 40(0x28) */
	PON_RESTART_REASON_HS_PWROFF_CHG	  = 0x28,
	PON_RESTART_REASON_HS_ENG_TEST		  = 0x29,
	PON_RESTART_REASON_HS_NORMAL_REBOOT   = 0x2a,
	PON_RESTART_REASON_HS_INITCALL_LOG	  = 0x2b,
