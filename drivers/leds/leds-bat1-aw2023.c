...
const unsigned char aw2023_bat1reg_access[AW2023_REG_MAX] = {
				...
				struct device_attribute *attr, char *buf)
{
	...
	for(i=0; i<AW2023_REG_MAX; i++) {
		if(!(aw2023_bat1reg_access[i]&REG_RD_ACCESS))
		continue;
...
static struct of_device_id aw2023_match_table[] = {
	{ .compatible = "awinic,bat1_aw2023_led",},
	{ },
};
...
static int __init aw2023_bat1led_init(void)
{
	return i2c_add_driver(&aw2023_led_driver);
}
module_init(aw2023_bat1led_init);

static void __exit aw2023_bat1led_exit(void)
{
	i2c_del_driver(&aw2023_led_driver);
}
module_exit(aw2023_bat1led_exit);
