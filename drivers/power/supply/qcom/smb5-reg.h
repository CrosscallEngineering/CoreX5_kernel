...
#define USB_USBIN_ADAPTER_ALLOW_REG		(USBIN_BASE + 0x60)
#define USB_USBIN_ADAPTER_ALLOW_MASK		GENMASK(3,0)
enum {
	USBIN_ADAPTER_ALLOW_5V = 0,
	USBIN_ADAPTER_ALLOW_9V = 0x02,
	USBIN_ADAPTER_ALLOW_5V_OR_9V  = 0x03, /*Defautl value*/
	USBIN_ADAPTER_ALLOW_5V_TO_9V  = 0x08,
};
