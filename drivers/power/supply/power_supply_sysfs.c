...
static ssize_t power_supply_show_property(struct device *dev,
	...
	else if ((off == POWER_SUPPLY_PROP_STATUS_BAT1) || (off == POWER_SUPPLY_PROP_STATUS_BAT2))
		return sprintf(buf, "%s\n", power_supply_status_text[value.intval]);
...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(capacity_bat1), /* for battery 1 */
	POWER_SUPPLY_ATTR(capacity_bat2), /* for battery 1 */
#endif /*CONFIG_HISENSE_CW2015_FG*/
#ifdef CONFIG_HISENSE_SGM_DOUBLE_BATTERIES
	POWER_SUPPLY_ATTR(status_bat1),/* for battery 1 */
	POWER_SUPPLY_ATTR(status_bat2), /* for battery 2 */
#endif /*CONFIG_HISENSE_SGM_DOUBLE_BATTERIES*/
