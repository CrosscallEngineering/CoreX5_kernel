...
#define Type_C_Implements_Try_SNK NO	/*Solve the issue that UFP cannot be switched to DFP mode.*/
...
#define PD_Power_as_Sink 19800                //; 19.8W
#else
