...
#define FT8006S_GESTURE_POINTS_NUM		128
...
#if defined(CONFIG_TOUCHSCREEN_FTS_GESTURE)
	bool gesture_en;
	u16 gesture_track_x[FT8006S_GESTURE_POINTS_NUM];
	u16 gesture_track_y[FT8006S_GESTURE_POINTS_NUM];
...
extern int ft5526_get_fs_fw_version(struct device *dev, char *buf);
extern	int ft5526_proc_fw_update(struct device *dev, bool force);
extern int ft5526_check_fw_update_need(struct device *dev);
extern void ft5526_ts_register_productinfo(struct fts_ts_data *ts_data);
