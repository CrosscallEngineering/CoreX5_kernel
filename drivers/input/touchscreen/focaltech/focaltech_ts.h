...
#define FT_FW_MAX_SIZE		95232

/* Firmware file is not supporting minor and sub minor so use 0 */
#define FT_FW_FILE_MAJ_VER(x)	((x)->data[(x)->size - 2])
#define FT_6436FW_FILE_MAJ_VER(x)	((x)->data[266])
#define FT_5452FW_FILE_MAJ_VER(x)	((x)->data[270])
#define FT_5422uFW_FILE_MAJ_VER(x)	((x)->data[20])
#define FT_8006FW_FILE_MAJ_VER(x)	((x)->data[270])
#define FT_8006PFW_FILE_MAJ_VER(x)	((x)->data[270])
#define FT_8719FW_FILE_MAJ_VER(x)	((x)->data[270])
#define FT_FW_FILE_MIN_VER(x)	0
#define FT_FW_FILE_SUB_MIN_VER(x) 0
#define FT_VERSION_SIZE				300
...
#define FTS_FLASH_PACKET_LENGTH     32  // FT8006P use
...
#define FT_FAMILY_MAX_TOUCHES		(10)
...
#define FT_DEBUG_DIR_NAME			"ts_debug_sub"
#else
...
enum {
	...
	FT_FT8006_FAMILY_ID_0x80 = 0x80,
	FT_FT8006P_FAMILY_ID_0x86 = 0x86,
	FT_FT8719_FAMILY_ID_0x87 = 0x87,
};
...
struct fw_upgrade_info {
	...
	u16 delay_55;
	u8 upgrade_id_1;
	u8 upgrade_id_2;//the upgrade_id_2 is for FT5446-DQS
	u8 upgrade_id_3;//the upgrade_id_3 is for FT5446-P03
	u8 upgrade_id_5;//the upgrade_id_5 is for FT5446-Q03
	u16 delay_readid;
...
struct ft5x06_ts_platform_data {
	...
	u32 tp_match_hw_gpio;
	u32 tp_match_hw_gpio_flags;
#endif
	u32 family_id;
	u32 x_max;
	u32 y_max;
	...
	u32 num_max_touches;
	u32 rawdata_range[2];
	u8 panelid_command[4];//the addr of panel_id is for FT5446-DQS & FT5446-Q03
	u8 panelid_command_1[4];//the addr of panel_id is for FT5446-P03
...
#ifdef CONFIG_TOUCHSCREEN_FT5X06_PRAMUPDATE
	u8 *pramboot;
	u32 pb_length;
#endif
	bool irq_can_wake;
