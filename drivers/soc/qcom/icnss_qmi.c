...
/* WCN39XX chip family */
#define WCN3980       0x4002
#define WCN3990       0x4001
#define WCN3950       0x4007
...
char wlfw_build_id[QMI_WLFW_MAX_BUILD_ID_LEN_V01 + 1];
char wcn_chipid[10];
char wcn_version[10];
...
int wlfw_cap_send_sync_msg(struct icnss_priv *priv)
{
	...
	case WCN3990:
		strlcpy(wcn_chipid, "WCN3990", sizeof("WCN3990"));
		break;
	case WCN3980:
		strlcpy(wcn_chipid, "WCN3980", sizeof("WCN3980"));
		break;
	case WCN3950:
		strlcpy(wcn_chipid, "WCN3950", sizeof("WCN3950"));
		break;
	default:
		strlcpy(wcn_chipid, "WCN39XX", sizeof("WCN39XX"));
		break;
	}
    sprintf(wcn_version, "%8x", priv->chip_info.chip_id);
	...
	if (resp->fw_build_id_valid){
		    ...
		    strlcpy(wlfw_build_id, resp->fw_build_id,
			       QMI_WLFW_MAX_BUILD_ID_LEN_V01 + 1);
	}
...
EXPORT_SYMBOL_GPL(wlfw_build_id);
EXPORT_SYMBOL_GPL(wcn_chipid);
EXPORT_SYMBOL_GPL(wcn_version);
