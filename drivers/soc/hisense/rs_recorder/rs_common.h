...
#define RS_DUMP_PATH             "/kdebuginfo/rs_recorder/"
...
#define SYS_GETDENTS    ksys_getdents64
...
extern int rs_recorder_compress(void *in, void *out,
		size_t inlen, size_t outlen);
extern int rs_recorder_decompress(char *inbuf, char *outbuf,
		int avail_in, int avail_out);

extern int init_last_kmsg_buffer(const char *msg_buf, int len);
extern int init_last_kmsg_proc_node(void);
